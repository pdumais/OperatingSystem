...
#define GET_APIC_ID32(reg) mov APIC_BASE+0x20,reg; shr $24,reg
#define GET_APIC_ID(reg) push %rdi; mov $(APIC_BASE+0x20),%rdi; btsq $MIRROR_BIT,%rdi; mov (%rdi),reg; shr $24,reg; pop %rdi
#define STACK_ADDRESS_PAGE_TABLE_OFFSET (((((STACK0TOP_VIRTUAL_ADDRESS-1-THREAD_CODE_START))>>12)<<3))
#define STACK3_ADDRESS_PAGE_TABLE_OFFSET (((((STACK3TOP_VIRTUAL_ADDRESS-1-THREAD_CODE_START))>>12)<<3))
#define META_ADDRESS_PAGE_TABLE_OFFSET (((((META_VIRTUAL_ADDRESS-THREAD_CODE_START))>>12)<<3))
#define CODE_ADDRESS_PAGE_TABLE_OFFSET 0 
