...
run:
	qemu-system-x86_64 --enable-kvm -cpu host -smp 4 -option-rom sgabios.bin -hda image/disk.img -hdb userapps/disk.img -monitor stdio -curses -net nic,model=virtio,macaddr=52:54:00:12:34:60 -net tap,vlan=0,ifname=tap4,script=no -net nic,model=rtl8139,macaddr=52:54:00:12:34:61 -net tap,vlan=1,ifname=tap7,script=no -m 4096 -d int,cpu_reset -D qemu.log -rtc base=localtime
